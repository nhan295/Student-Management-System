...
function ShowAssign({
  ...
  const handleEdit = (e) => {
    ...
    if (onEdit) {
      // nếu có hàm onEdit được truyền từ cha thì gọi hàm onEdit với id của assignment và các giá trị đã chỉnh sửa
      onEdit(assignment.assignment_id, {
        // gửi dữ liệu chỉnh sửa lên cha là AssignmentPage
  ...
  return (
    <div className="assignment-card">
      ...
      <div className="assign-container">
        ...
        <p>
          <strong>Học phần:</strong> {assignment.subject_name}
        </p>
        <p>
        ...
        <div style={{ marginTop: "10px" }}>
          ...
          <button
            ...
            onClick={() => onDelete && onDelete(assignment.assignment_id)}
          >
            Xoá
          </button>
        </div>

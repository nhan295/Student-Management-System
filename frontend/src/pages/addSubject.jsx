...
export default function AddSubject() {
  ...
  const [confirmParams, setConfirmParams] = useState({ isOpen: false, mode: '', data: null });
  ...
  const handleConfirm = async () => {
    ...
    try {
      if (mode === 'add') {
        ...
        await axios.delete(`http://localhost:3000/api/v1/subjects/${data.subject_id}`);
